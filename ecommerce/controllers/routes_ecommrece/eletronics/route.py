...
from schemas.ecommerce.schemas import ProductEletronicos, EspecificacoesEletronicos # Importando o schema Pydantic para validação
...
async def create_product(product: ProductEletronicos = Body(embed=True), db: Session = Depends(get_db)): # db esta sendo tipado como uma Sessao, que tem uma dependencia em fazer um get, no DB
