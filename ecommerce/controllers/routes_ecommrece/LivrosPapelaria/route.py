...
from schemas.ecommerce.schemas import EspecificacoesLivrosPapelaria, ProductLivrosPapelaria, ProductBase
from sqlalchemy.orm import Session
from models.ecommerce.models import Product_Livros_Papelaria
